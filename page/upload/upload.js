document.addEventListener('DOMContentLoaded', function() {
    // Get all DOM elements and add null checks
    ...
    if (uploadDateInput) uploadDateInput.value = today;
    if (updateDateInput) updateDateInput.value = today;
    ...
    // Получаем элементы DOM с проверками
    ...
    // Обработчики для кнопок с проверками
    if (uploadScenarioBtn && scenarioInput) {
    ...
    if (scenarioInput && uploadScenarioBtn) {
    ...
    if (imageInput && uploadImageBtn && screenshotImg) {
